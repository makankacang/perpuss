            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body p-5 bg-white shadow rounded">
                        <h1 class="title text-dark">Register Perpustakaan Digital</h1>
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror bg-white" name="email" value="{{ old('email') }}" required autocomplete="email">
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary text-light">{{ __('Register') }}</button>
                                    </div>
